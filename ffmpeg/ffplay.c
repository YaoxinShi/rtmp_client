...
static int screen_width = 960;// 0;
static int screen_height = 540;// 0;
static int screen_left = 50;// SDL_WINDOWPOS_CENTERED;
static int screen_top = 50;// SDL_WINDOWPOS_CENTERED;
