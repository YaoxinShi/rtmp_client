				...
				size_t *size, size_t a_idx)
{
	...
	*enc++ = AMF_ECMA_ARRAY;
	...
	enc_bool_val(&enc, end, "2.1", audio_channel /*audio_output_get_channels(audio)*/ == 3);
	enc_bool_val(&enc, end, "3.1", audio_channel /*audio_output_get_channels(audio)*/ == 4);
	enc_bool_val(&enc, end, "4.0", audio_channel /*audio_output_get_channels(audio)*/ == 4);
	enc_bool_val(&enc, end, "4.1", audio_channel /*audio_output_get_channels(audio)*/ == 5);
	enc_bool_val(&enc, end, "5.1", audio_channel /*audio_output_get_channels(audio)*/ == 6);
	enc_bool_val(&enc, end, "7.1", audio_channel /*audio_output_get_channels(audio)*/ == 8);
...
#else
	enc_str_val(&enc, end, "encoder", "libobs");
#endif
